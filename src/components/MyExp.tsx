      ...
      <div className={styles.exp}>
        <div className={styles.expCard}>
          <div>
            ...
            <div className={styles.expYear}>Sep 2024 — Present </div>
            <p>
              Crafted custom web applications that empower businesses with modern,
              responsive frontend architectures. Leveraging React, Tailwind CSS,
              and the Shadcn component library, I design modular,
              component‑based systems and reusable Sanity CMS templates that
              accelerate onboarding and streamline development. By structuring
              pages as flexible content blocks and integrating Sanity.io for
              intuitive, non‑technical content management, I deliver scalable
              websites that clients can independently extend and
              maintain—ensuring consistency, efficiency, and a seamless digital
              experience.
            </p>
        ...
        <div className={styles.expCard}>
          <div>
            ...
            <div className={styles.expYear}>
              Jan 2024 — Aug 2024 <span>( Full-Time )</span>
            </div>
            <p>
              Enhanced the existing Globiance Exchange by adding new features and resolving bugs, improving platform
              functionality and performance. Developed a decentralized exchange
              (DEX) inspired by Uniswap, with wallet connectivity, token search,
              and swap functionality. Built features like pool creation and
              liquidity management. Integrated smart contract SDKs for secure
